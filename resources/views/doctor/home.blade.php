...
<html lang="en">
    ...
    <body class="compact-menu">
        @php
            $doctor = DB::table('doctors')->where('id', Auth::guard()->id())->first();
        @endphp
        ...
        <main class="page-content content-wrap">
            <div class="navbar">
                <div class="navbar-inner">
                    ...
                    <div class="logo-box">
                    <a href="{{ route('doctor.dashboard') }}" class="logo-text"><span>Doctor Panel</span></a>
                    </div><!-- Logo Box -->
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                ...
                                <li class="dropdown">
                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                        <span class="user-name">{{ $doctor->full_name }}<i class="fa fa-angle-down"></i></span>
                                    ...
                                    <ul class="dropdown-menu dropdown-list" role="menu">
                                        ...
                                        <li role="presentation"><a href="{{ route('doctor.logout') }}" onclick="event.preventDefault();
            ...
            <div class="page-sidebar sidebar">
                <div class="page-sidebar-inner slimscroll">
                    ...
                    <li class="active"><a href="{{ route('doctor.dashboard') }}" class="waves-effect waves-button"><span class="menu-icon icon-home"></span><p>Dashboard</p><span class="active-page"></span></a></li>
                    ...
                    <li class="droplink"><a href="#" class="waves-effect waves-button"><span class="menu-icon icon-envelope-open"></span><p>Appointments</p><span class="arrow"></span></a>
                        <ul class="sub-menu">
                            <li><a href="{{ route('pending.appointment') }}">Pending Appointments</a></li>
                            <li><a href="{{ route('manage.appointment') }}">Manage Appointments</a></li>
                            <li><a href="{{ route('appointment.history') }}">Appointments History</a></li>
                        </ul>
                    </li>
