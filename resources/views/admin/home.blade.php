        ...
        <main class="page-content content-wrap">
            ...
            <div class="page-sidebar sidebar">
                <div class="page-sidebar-inner slimscroll">
                    ...
                    <li class="droplink"><a href="#" class="waves-effect waves-button"><span class="menu-icon icon-envelope-open"></span><p>Patients</p><span class="arrow"></span></a>
                        <ul class="sub-menu">
                            <li><a href="{{ route('pending.users') }}">New User</a></li>
